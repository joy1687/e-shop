...
<select name ="size"ide="size" class="form-control">
<option value=""></option>
...
<div class="modal-footer">
    ...
    <button class="btn btn-warning" type="submit"><span class="glyphicon glyphicon-shopping-cart">Add to the cart</button>
</div>
</div>
</div>
</div>